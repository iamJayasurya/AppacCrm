    ...
    <div className="rpt-wrp">
            <div className='report-frm  feedback-frm'>
                ...
                <p>Resignation Date</p>
                 <input type='date'  name="resignationdate"></input>
                </div>
                /<div>
                <p>Questions</p>
                <textarea className='ques-textarea' name="description" placeholder="Brief Description"  ></textarea>
                </div>
                <div class="leave-bt-wrp"><button type="submit" class="submit"  name="sendreg"  value="Send Resignation">Submit</button><button type="clear" class="clear">Clear</button></div>
            </div>
            <div className='report-sts'>
            <p className='mt0'>Resignation</p>
